...
import {ADD_TO_CART, DECREASE_CART, REMOVE_FROM_CART, CLEAR_CART, CALCULATE_SUBTOTAL, CALCULATE_TOTAL_QUANTITY, SAVE_URL} from '../../redux/slice/cartSlice'
...
const Cart = () => {
  ...
  //Runs everytime cart item changes
  useEffect(() => {
